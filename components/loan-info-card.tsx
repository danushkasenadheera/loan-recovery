      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <dl className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div>
              <dt className="text-xs text-muted-foreground">Bank Code</dt>
              <dd className="text-sm font-medium mt-0.5">{loan.bankCode}</dd>
            </div>
            <div>
              <dt className="text-xs text-muted-foreground">Loan Type</dt>
              <dd className="text-sm font-medium mt-0.5">{loan.loanType}</dd>
            </div>
            <div>
              <dt className="text-xs text-muted-foreground">Loan Code</dt>
              <dd className="text-sm font-medium font-mono mt-0.5">{loan.loanCode}</dd>
            </div>
            <div>
              <dt className="text-xs text-muted-foreground">Loan Name</dt>
              <dd className="text-sm font-medium mt-0.5">{loan.loanName}</dd>
            </div>
            <div className="col-span-2 sm:col-span-4">
              ...
              <dd className="text-sm font-medium mt-0.5">{loan.loanAddress || "Not provided"}</dd>
            </div>
            {hasLocation && (
              <div className="col-span-2 sm:col-span-4">
